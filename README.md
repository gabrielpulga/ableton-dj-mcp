...
production. Includes genre-aware context, music theory utilities, and 21 tools
covering tracks, clips, devices, scenes, and transport control.
...
lightweight portal bridges your AI client (stdio) to the server (HTTP :3350).
...
Built on [Producer Pal](https://github.com/adamjmurray/producer-pal) by Adam
Murray.
